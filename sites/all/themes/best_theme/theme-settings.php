 ...
 */
function best_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['best_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('best_theme sample setting'),
  '#default_value' => theme_get_setting('best_theme_example'),
